...
public final class ResumeDtos { private ResumeDtos(){}
 ...
 public record SaveResumeRequest(@NotNull String fullName,@Min(16) @Max(100) int age,@NotNull String location,@NotNull String headline,@NotNull String summary,@Size(max=100) List<@NotBlank @Size(max=200) String> skills,@NotNull List<@Valid Experience> experiences,@Min(0) int expectedVersion){}
}
