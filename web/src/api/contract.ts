...
export const apiPaths = {
  ...
  requestCompanyChanges: (companyId: string) => `/admin/companies/${companyId}/request-changes`,
  moderationCases: '/admin/moderation/cases',
  moderationCase: (caseId: string) => `/admin/moderation/cases/${caseId}`,
